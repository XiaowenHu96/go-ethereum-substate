...
func (evm *EVM) Call(caller ContractRef, addr common.Address, input []byte, gas uint64, value *big.Int) (ret []byte, leftOverGas uint64, err error) {
	if evm.CallContext != nil {
		return evm.CallContext.Call(evm, caller, addr, input, gas, value)
	}
...
func (evm *EVM) CallCode(caller ContractRef, addr common.Address, input []byte, gas uint64, value *big.Int) (ret []byte, leftOverGas uint64, err error) {
	if evm.CallContext != nil {
		return evm.CallContext.CallCode(evm, caller, addr, input, gas, value)
	}
	if evm.Config.NoRecursion && evm.Depth > 0 {
		return nil, gas, nil
	}
...
func (evm *EVM) DelegateCall(caller ContractRef, addr common.Address, input []byte, gas uint64) (ret []byte, leftOverGas uint64, err error) {
	if evm.CallContext != nil {
		return evm.CallContext.DelegateCall(evm, caller, addr, input, gas)
	}
	if evm.Config.NoRecursion && evm.Depth > 0 {
		return nil, gas, nil
	}
...
func (evm *EVM) StaticCall(caller ContractRef, addr common.Address, input []byte, gas uint64) (ret []byte, leftOverGas uint64, err error) {
	if evm.CallContext != nil {
		return evm.CallContext.StaticCall(evm, caller, addr, input, gas)
	}
	if evm.Config.NoRecursion && evm.Depth > 0 {
		return nil, gas, nil
	}
...
func (evm *EVM) Create(caller ContractRef, code []byte, gas uint64, value *big.Int) (ret []byte, contractAddr common.Address, leftOverGas uint64, err error) {
	if evm.CallContext != nil {
		return evm.CallContext.Create(evm, caller, code, gas, value)
	}
...
func (evm *EVM) Create2(caller ContractRef, code []byte, gas uint64, endowment *big.Int, salt *uint256.Int) (ret []byte, contractAddr common.Address, leftOverGas uint64, err error) {
	if evm.CallContext != nil {
		return evm.CallContext.Create2(evm, caller, code, gas, endowment, salt)
	}
